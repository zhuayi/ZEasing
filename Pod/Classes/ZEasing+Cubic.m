...
+ (CGFloat)easeIn:(CGFloat)currentTime fromValue:(CGFloat)fromValue toValue:(CGFloat)toValue duration:(CGFloat)duration {
    ...
    return (currentTime >= duration) ? fromValue + toValue : toValue * (currentTime /= duration) * currentTime * currentTime + fromValue;
}
...
+ (CGFloat)easeOut:(CGFloat)currentTime fromValue:(CGFloat)fromValue toValue:(CGFloat)toValue duration:(CGFloat)duration {
    ...
    return (currentTime >= duration) ? fromValue + toValue : toValue * (currentTime = currentTime / duration - 1) * currentTime * currentTime + fromValue;
}
...
+ (CGFloat)easeInOut:(CGFloat)currentTime fromValue:(CGFloat)fromValue toValue:(CGFloat)toValue duration:(CGFloat)duration {
    ...
    if ((currentTime /= duration / 2) < 1) {
        ...
        return (currentTime >= duration) ? fromValue + toValue : toValue / 2 * currentTime * currentTime * currentTime + fromValue;
    } else {
        
        return (currentTime >= duration) ? fromValue + toValue : toValue / 2 * ((currentTime -= 2) * currentTime * currentTime + 2) + fromValue;
    }
}
